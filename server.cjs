...
function adminCabinetPage(db){
  const items=[
    ...
    ['Замовлення','/admin-orders','🧾'],['Нова заявка','/admin-applications','📲'],['Товари','/admin-products','📦'],['Статистика','/admin-statistics','📊'],['Штрихкоди товарів','/admin-barcodes','▥',(db.productBarcodes||[]).length],
